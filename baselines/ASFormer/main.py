...
num_epochs = 50  # reduced from paper default (120) -- ~54hr GPU budget wasn't practical here
...
# Features, groundtruth, splits, and mapping are read directly from the
# shared repo-root dataset/ (see dataset_paths.py) -- no local data/ copy.
vid_list_file = dataset_paths.split_bundle_path("train")
vid_list_file_tst = dataset_paths.split_bundle_path("test")
features_path = None
gt_path = None
