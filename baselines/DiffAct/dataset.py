...
def get_data_dict(feature_dir, label_dir, video_list, event_list, sample_rate=4, temporal_aug=True, boundary_smooth=None):
    # feature_dir/label_dir are unused -- features and groundtruth are read
    # directly from the shared repo-root dataset/ (see dataset_paths.py).
    ...
    for video in tqdm(video_list):
        ...
        event_file = dataset_paths.groundtruth_path(video)
        ...
        feature = dataset_paths.load_combined_features(video)
