...
eval_metrics.py
=====================================================================
Evaluates the trained MS-TCN2 checkpoint (epoch-100, split_1) on the
...
# ---------------------------------------------------------------------
num_layers_PG, num_layers_R, num_R, num_f_maps, features_dim = 11, 10, 3, 64, 2048
model = MS_TCN2(num_layers_PG, num_layers_R, num_R, num_f_maps, features_dim, num_classes).to(device)
model.eval()
